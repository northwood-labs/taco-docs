...
// would be fragile when aliases are involved), PreRunEFunc reads the
// "command" annotation to know what format was requested. The "kind"
// annotation categorizes the command for potential future use in help
// grouping or plugin discovery.
