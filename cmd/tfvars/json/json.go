...
// NewCommand registers the "tfvars json" subcommand. JSON is an alternative to
// HCL for providing variable values (via .tfvars.json files). This format is
// particularly useful when variable values are programmatically generated by
// scripts or CI pipelines that naturally produce JSON output.
