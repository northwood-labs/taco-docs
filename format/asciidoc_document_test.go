...
// Golden-file test ensuring AsciiDoc document output matches expected fixtures
// across all config combinations (sections, settings, anchors, output values).
// Catches regressions in template rendering.
